...
sudo apt install -y build-essential grub-common nasm gcc git qemu-system-i386 grub-pc-bin lua-socket xorriso gcc-8-multilib gcc-arm-none-eabi libgcc-7-dev-i386-cross git
