...
sudo apt install -y build-essential grub-common nasm gcc git liblua50:i386 liblua5.1-0-dev qemu-system-i386 grub-pc-bin lua-socket xorriso gcc-8-multilib gcc-arm-none-eabi libgcc-7-dev-i386-cross
